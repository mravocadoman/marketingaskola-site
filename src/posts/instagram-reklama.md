...
Ja gribi visu Meta reklāmu sistēmu apgūt secīgi un ar savu kontu rokās, to mācām [Meta reklāmas kursā](/meta-reklamas-kurss/): vienā {% offer "meta-reklamas-kurss", "hours" %} garā tiešsaistes nodarbībā, kur ejam cauri konta uzbūvei un mērīšanas pamatiem, kampaņu mērķiem, auditorijām, formātiem un kreatīvu sagatavošanai. Grupā par {% offer "meta-reklamas-kurss" %}. Ja labāk gribi, lai to izdara kāds cits, un reklāmai mēnesī vari atvēlēt vismaz {% offer "meta-floor" %}, apskati [Meta reklāmas pakalpojumu](/facebook-reklama/) vai izrunā savu situāciju [individuālā konsultācijā](/marketinga-konsultacijas/). Par stundu maksāsi {% offer "60" %}.
